            ...
            <div id="contenido"  >
                <div class="container-fluid">
                    <div id="main" class="row-fluid" >
                        ...
                        <!-- LO NUEVO -->
                        <div id="menus" class="span10 navbar navbar-static-top"> 
                            <div class="navbar-inner">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="dropdown divider-vertical"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Tópicos <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
