<%-- 
    Document   : eliminarAplicacion1
    Created on : Jul 30, 2013, 9:33:22 PM
    Author     : hector
--%>
...
<html>
    ...
    <body>
        <form class="formularios form-horizontal" method="POST" action="${pageContext.request.contextPath}/EliminarAplicacionServlet1">
