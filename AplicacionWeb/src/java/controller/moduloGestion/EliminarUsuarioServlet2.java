...
/**
 * Clase que permite eliminar un usuario de la base de datos a través del
 * módulo de gestión.
 * @author hector
 */
@WebServlet(name = "EliminarUsuarioServlet2", urlPatterns = {"/EliminarUsuarioServlet2"})
public class EliminarUsuarioServlet2 extends HttpServlet {
     ...
     * a un usuario para su eliminación.
    ...
    public boolean ejecutarQuery(HttpServletRequest request){
        ...
        if (request != null) {
            conexion.ejecutarQuery("DELETE FROM USUARIOS WHERE ID="+id);
            return true;
        }
        return false;
    }
