    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            boolean valor = conexion.ejecutarQuery("INSERT INTO USUARIOS (ID,NOMBRE,APELLIDO,CORREO,CONTRASENA)"
                    + " VALUES(S_USUARIOS.NEXTVAL,'"+nombre+"','"+apellido+"','"+correo+"','"+contrasena+"' )");
            if (valor==true){ 
