 ...
 * @author sam
 */
public class CaracteristicasSD_Cliente {
    ...
    public static void main(String[] args) {
        ...
        //LogicaAplicacion logicaAplicacion = new LogicaAplicacion(libreriaMensajes, datosAplicacion, Integer.valueOf(args[3]),args[4],args[5]);
        LogicaAplicacion logicaAplicacion = LogicaAplicacion.getInstancia(libreriaMensajes, datosAplicacion, Integer.valueOf(args[3]),args[4],args[5]);
