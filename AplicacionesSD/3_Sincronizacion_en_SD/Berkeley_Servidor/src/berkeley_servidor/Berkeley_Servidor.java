 ...
 * @author sam
 */
public class Berkeley_Servidor {
    ...
    public static void main(String[] args) {
        ...
        LogicaAplicacion logicaAplicacion = LogicaAplicacion.getInstancia(libreriaMensajes, datosAplicacion, Integer.valueOf(args[3]),Integer.valueOf(args[4]));
