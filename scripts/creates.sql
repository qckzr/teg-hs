...
CREATE TABLE TOPICOS
  (
    ...
    CONSTRAINT FK_USUARIO_TOPICO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIOS(ID) ON DELETE CASCADE,
...
CREATE TABLE PREGUNTAS
  (
    ...
    CONSTRAINT FK_TOPICO_PREGUNTA FOREIGN KEY (ID_TOPICO) REFERENCES TOPICOS(ID) ON DELETE CASCADE
  );
CREATE TABLE RESPUESTAS
  (
    ID          NUMBER(4) PRIMARY KEY,
    OPCION      VARCHAR2(120) NOT NULL,
    ID_PREGUNTA NUMBER(4) NOT NULL,
    CORRECTA    VARCHAR2(10),
    CONSTRAINT FK_PREGUNTA_RESPUESTA FOREIGN KEY (ID_PREGUNTA) REFERENCES PREGUNTAS(ID) ON DELETE CASCADE,
...
CREATE TABLE MENSAJES_AGENTE
  (
    ...
    CONSTRAINT FK_NODO_MENSAJEAGENTE FOREIGN KEY (ID_NODO) REFERENCES NODOS(ID) ON DELETE CASCADE,
...
CREATE TABLE APLICACIONES
  (
    ...
    ID_TOPICO           NUMBER(4) NOT NULL,
    CONSTRAINT FK_TOPICO_APLICACION FOREIGN KEY (ID_TOPICO) REFERENCES TOPICOS(ID) ON DELETE CASCADE
  );
CREATE TABLE ESCENARIOS
  (
    ...
    IMAGEN        VARCHAR2(100),
    CONSTRAINT FK_APLICACION_ESCENARIO FOREIGN KEY (ID_APLICACION) REFERENCES APLICACIONES(ID) ON DELETE CASCADE
  );
CREATE TABLE EJECUTABLES
  (
    ...
    ID_APLICACION   NUMBER(4) NOT NULL,
    ID_NODO         NUMBER(4) NOT NULL,
    CONSTRAINT FK_APLICACION_EJECUTABLES FOREIGN KEY (ID_APLICACION) REFERENCES APLICACIONES(ID) ON DELETE CASCADE,
    CONSTRAINT FK_NODO_EJECUTABLES FOREIGN KEY (ID_NODO) REFERENCES NODOS(ID) ON DELETE CASCADE,
...
CREATE TABLE PARAMETROS
  (
    ...
    CONSTRAINT FK_EJECUTABLE_PARAMETRO FOREIGN KEY (ID_EJECUTABLE) REFERENCES EJECUTABLES(ID) ON DELETE CASCADE
  );
CREATE TABLE INFORMACION_EJECUTABLE
  (
    FECHA_DEPLOY  DATE NOT NULL,
    HORA_DEPLOY   DATE NOT NULL,
    ID_PROCESO    NUMBER (6) NOT NULL,
    ID_EJECUTABLE NUMBER(4),
    CONSTRAINT PK_P_N PRIMARY KEY (ID_EJECUTABLE,ID_PROCESO),
    CONSTRAINT FK_EJECUTABLE_P_N FOREIGN KEY (ID_EJECUTABLE) REFERENCES EJECUTABLES(ID) ON DELETE CASCADE
  );
/*CREATE TABLE MENSAJE_ENTRE_NODOS
  (
    ...
    ID_EJECUTABLE NUMBER(4) NOT NULL,
    ID_PROCESO    NUMBER(6) NOT NULL,
    CONSTRAINT FK_E_N_MENSAJEENTRENODOS FOREIGN KEY (ID_EJECUTABLE,ID_PROCESO) REFERENCES E_N(ID_EJECUTABLE,ID_PROCESO) ON DELETE CASCADE
  ); */
...
CREATE TABLE EJECUTABLE_EVENTO
  (
    ID_EJECUTABLE         NUMBER(4),
    ID_EVENTO     NUMBER(4),
    CONSTRAINT PK_E_E PRIMARY KEY (ID_EJECUTABLE,ID_EVENTO),
    CONSTRAINT FK_EJECUTABLE_E_E FOREIGN KEY (ID_EJECUTABLE) REFERENCES EJECUTABLES(ID) ON DELETE CASCADE,
    CONSTRAINT FK_EVENTO_E_E FOREIGN KEY (ID_EVENTO) REFERENCES EVENTOS(ID) ON DELETE CASCADE
