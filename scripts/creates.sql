...
CREATE TABLE TOPICOS(
    ...
    DESCRIPCION VARCHAR2(5000) NOT NULL,
...
CREATE TABLE MENSAJES_AGENTE(
    ID NUMBER (4) PRIMARY SKEY,
    ID PROCESO NUMBER(6) NOT NULL,
    CANTIDAD_PROCESOS NUMBER(4) NOT NULL,
    MEMORIA_DISPONIBLE NUMBER(5) NOT NULL,
    USO_CPU NUMBER(3) NOT NULL,
    PUERTOS_DISPONIBLES VARCHAR2(100) NOT NULL,
...
CREATE TABLE APLICACIONES(
    ...
    INSTRUCCIONES VARCHAR2(5000) NOT NULL,
    ID_TOPICO NUMBER(4) NOT NULL,
...
CREATE TABLE E_N(
    ...
    CONSTRAINT PK_P_N PRIMARY KEY (ID_NODO,ID_EJECUTABLE,ID_PROCESO), #PENDIENTE
    CONSTRAINT FK_NODO_P_N FOREIGN KEY (ID_NODO) REFERENCES NODO(ID),
    CONSTRAINT FK_EJECUTABLE_P_N FOREIGN KEY (ID_EJECUTABLE) REFERENCES EJECUTABLE(ID)
    );
...
CREATE SEQUENCE S_MENSAJES_AGENTES START WITH 1 INCREMENT BY 1 NOMAXVALUE NOCACHE;
