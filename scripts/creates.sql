...
CREATE TABLE E_N
  (
    ...
    CONSTRAINT FK_NODO_P_N FOREIGN KEY (ID_NODO) REFERENCES NODOS(ID) ON DELETE CASCADE,
...
CREATE TABLE MENSAJE_ENTRE_NODOS
  (
    ...
    ID_EJECUTABLE NUMBER(4) NOT NULL,
    ID_PROCESO    NUMBER(6) NOT NULL,
    CONSTRAINT FK_E_N_MENSAJEENTRENODOS FOREIGN KEY (ID_NODO,ID_EJECUTABLE,ID_PROCESO) REFERENCES E_N(ID_NODO,ID_EJECUTABLE,ID_PROCESO) ON DELETE CASCADE
  );
